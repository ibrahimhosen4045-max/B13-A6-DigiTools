...
const Hero = () => {
  return (
    <div className='flex flex-col md:flex-row w-11/12  mx-auto container items-center justify-around gap-5 py-15 pt-25'>
      <div className='space-y-1.5 lg:space-y-3 flex-1 px-2 lg:px-0 flex flex-col items-center text-center md:items-start md:text-left'>
        ...
        <h1 className='text-[40px] lg:text-[72px] font-extrabold max-w-160'>Supercharge Your Digital Workflow</h1>
